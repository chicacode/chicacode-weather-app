      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap">
          <div className="w-full lg:w-6/12 px-4">
            <h4 className="text-3xl font-medium text-primary">
              Let's keep in touch!
            </h4>
            <h5 className="text-lg mt-0 mb-2 text-gray">
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="flex flex-wrap items-top mb-6">
              <div className="w-full lg:w-4/12 px-4 ml-auto">
                <span className="block uppercase text-primary text-sm  mb-2">
                  Useful Links
                </span>
                <ul className="list-unstyled">
                  <li>
                    <a className="text-gray hover:text-indigo  block pb-2 text-sm"
        ...
        <div className="flex flex-wrap items-center md:justify-between justify-center">
          <div className="w-full md:w-4/12 px-4 mx-auto text-center">
            <div className="text-sm text-gray font-medium py-1">
              Copyright © {new Date().getFullYear()}{" "}ChicaCode{" - "}
              <a
                href="https://github.com/chicacode"
                target={'_blank'}
                className="text-gray hover:text-indigo"
              >
                Github
              </a>
            </div>
